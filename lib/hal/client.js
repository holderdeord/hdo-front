...
* smarter caching (maybe through https://github.com/cucumber-ltd/eu?)
...
HalClient.prototype._fetch = function (url) {
    ...
    if (hit) {
        console.log('...', 'CACHE HIT:' + Object.keys(this.cache.store).length);
    ...
    return request({
        ...
        self.cache.save(response.request.uri.href, result, 60);
